...
if(isset($_POST['posttask'])){
    ...
    $task = mysqli_query($conn, $task);
       ...
       $inserttask = "INSERT INTO `task`(`User`,`Title`, `Description`,`Category`, `Latitude`, `Longitude`,`Budget`,`Date`) 
                          VALUES ('$user','$Title','$Description','$Category','$Latitude','$Longitude','$Budget','$Date')";
                            ...
                            <div class="container">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-6 col-xl-4">
                                        ...
                                        <div class="service rounded text-center">
                                            <a onclick="setCategory('Hospital & Clinics')" href="#"><img src="./img/hospital.png" width="80px"><br>
...
?>
        ...
        <div class="step">
            ...
            <!-- <div class="mb-3">
                <input type="text" placeholder="e.g: Lahore, Pakistan" oninput="this.className = ''" name="location" id="locationInput">
                <div class="errorfield" id="locationError">
               <span class="formerror"></span>
           </div>
            </div> -->
...
?>
                ...
                <div class="nav-item dropdown servicemobile">
                    ...
                    <div class="dropdown-menu categry m-0">
                        ...
                        <a onclick="setCategory('Hospital & Clinics')" href="#" class="dropdown-item">Hospital & Clinics</a>
      ...
      ?>
            <div class="dropdown useraccount">
                <a href="#" class="nav-link" data-bs-toggle="dropdown">
                    ...
                    <?php if ($Image) { ?>
                        <img src="<?php echo $Image; ?>" alt="" class="rounded-circle" style="width: 30px; height: 30px; object-fit: cover; margin-right: 5px; border:1px solid rgb(212, 212, 212);">
                    <?php } else { ?>
                        <img src="<?php echo $defaultimg; ?>" alt="Default Profile Picture" class="rounded-circle" style="width: 30px; height: 30px; object-fit: cover; margin-right: 5px; border:1px solid rgb(212, 212, 212);">
                    <?php } ?>
                </a>
                <div class="dropdown-menu m-0">
            ...
            <div class="usermobile">
                <a href="profile.php?ID=<?php echo $result ['ID']; ?> ">
                    <div class= "profiledp">
                    <?php if ($Image) { ?>
                        <img src="<?php echo $Image; ?>" alt="" class="rounded-circle" style="width: 30px; height: 30px; object-fit: cover; margin-right: 5px;">
                    <?php } else { ?>
                        <img src="<?php echo $defaultimg; ?>" alt="Default Profile Picture" class="rounded-circle" style="width: 30px; height: 30px; object-fit: cover; margin-right: 5px; border:1px solid rgb(77, 77, 77);">
                    <?php } ?>
                    </div>
                </a>
            </div>
...
<script>
    ...
    var vanishing_date = new Date('2024-04-15'),
